...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o mydatastore.o clothing.o movie.o book.o review.o
...
product.o: product.cpp product.h clothing.h movie.h book.h
...
mydatastore.o: mydatastore.cpp mydatastore.h heap.h
